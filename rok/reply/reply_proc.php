...
if($wtype=='wr'){ //작성
    ...
    $sql = "insert into reply_table_rok(rt_writer,rt_text,rt_pwd,rt_ip) values('{$rt_writer}','{$rt_text}','{$rt_pwd}','{$u_ip}');";
    ...
    $sql = "update reply_table_rok set rt_isuse='n' where rt_id='{$rt_id}' and rt_pwd='{$rt_pwd}';";
