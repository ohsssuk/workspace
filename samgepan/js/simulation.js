...
function setCommander(){
    ...
    $('.commander_part').each(function(index){
        ...
        commanderList[index]['variation']['g_wdr'] = Number($(this).find('[name="give_weapon_damage_rate[]"]').val()) + classAdventage + moraleAdvendtage;
        commanderList[index]['variation']['g_tdr'] = Number($(this).find('[name="give_trick_damage_rate[]"]').val()) + classAdventage + moraleAdvendtage;
        commanderList[index]['variation']['r_wdr'] = Number($(this).find('[name="receive_weapon_damage_rate[]"]').val()) + classAdventage;
        commanderList[index]['variation']['r_tdr'] = Number($(this).find('[name="receive_trick_damage_rate[]"]').val()) + classAdventage;
...
function getDamage(activeCommander, targetCommander, category, rate){
    ...
    console.log(normalDamage, rate, giveDamageVarition, recieveDamageVarition);
...
function getResult(){
    ...
    gtag('event', 'combat_simulation:getResult');
}
