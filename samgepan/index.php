    ...
    <div class="main">
        ...
        <div class="input_box">
            ...
            <div class="select_build">
                <select onchange="buildCal.checkBuildKind(this)" name="select_build_kind" id="select_build_kind">
                    <option value="">건물 종류</option>
                    <option value="kunwang">군왕전</option>
                    <option value="kunyeong">군영</option>
                    <option value="saryungdan">사령단</option>
                    <option value="byungA">병영(방패,궁,병기)</option>
                    <option value="byungsageunA">병사전(무력,방어)</option>
                    <option value="byungsageunB">병사전(모략,속도)</option>
                    <option value="jing">징병소</option>
                    <option value="wongudan">원구단</option>
                    <option value="sagidan">사기단</option>
                    <option value="bulmok">벌목장</option>
                    <option value="jechul">제철소</option>
                    <option value="chesuk">채석장</option>
                    <option value="chango">창고</option>
                    <option value="minga">민가</option>
                </select>
                <select onchange="buildCal.checkBuildLevel(this)" name="select_build_level" id="select_build_level">
