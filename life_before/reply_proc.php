...
if($wtype=='wr'){ //작성
    ...
    $sql = "insert into reply_table(rt_writer,rt_text,rt_pwd,rt_ip) values('{$rt_writer}','{$rt_text}','{$rt_pwd}','{$u_ip}');";
    ...
    $sql = "update reply_table set rt_isuse='n' where rt_id='{$rt_id}' and rt_pwd='{$rt_pwd}';";
    
    if($_POST['rt_pwd'] == 'master'){
        $sql = "update reply_table set rt_isuse='n' where rt_id='{$rt_id}';";
    }
